    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='thematics/default.png', upload_to='', verbose_name='Фото')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('room', models.CharField(blank=True, max_length=100, null=True, verbose_name='Помещение')),
                ...
                ('date_perform', models.DateTimeField(blank=True, default=datetime.datetime(2024, 1, 14, 15, 22, 43, 330859, tzinfo=datetime.timezone.utc), null=True, verbose_name='Дата проведения')),
                ('status', models.IntegerField(choices=[(1, 'Введён'), (2, 'В работе'), (3, 'Завершён'), (4, 'Отменён'), (5, 'Удалён')], default=1, verbose_name='Статус')),
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 1, 14, 15, 22, 43, 330859, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ...
                ('thematics', models.ManyToManyField(null=True, to='app.thematic', verbose_name='Выставки')),
            ],
            options={
